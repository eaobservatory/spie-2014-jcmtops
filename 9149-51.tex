...
desired. Ref.\ \citenum{tilanus2000} discusses the considerations for
...
\begin{table}
\caption{JCMT Weather Grades used for Project Selection. This table is an updated version of a table provided by Ref.\ \citenum{robson2002}.}
\label{tab:grades}
\begin{center}
...
Ref.\ \citenum{robson2002} which describes the properties of each grade and the
...
quality. Thus, as noted by Ref.\ \citenum{tilanus2000}, a tight
...
RxB3 receiver.\cite{1998SPIE.3357..620C} In Figure~\ref{fig:sc2}, the cumulative sky coverage of
